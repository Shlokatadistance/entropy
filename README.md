...
Note - I added shannon_entropy.py as the first entropy calculator in this repo, completely oblivious to the fact that scipy.stats has a the same entropy method implemented. Oh well.